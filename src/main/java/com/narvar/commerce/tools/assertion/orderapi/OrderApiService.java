...
public class OrderApiService {
    ...
    public OrderAssertionResponse validateOrders(List<ShopifyOrder> shopifyOrders, String authToken, String retailerId, Boolean checkAllOrders) throws Exception {
